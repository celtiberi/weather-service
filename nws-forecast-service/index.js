...
const exchange = rabbit.direct('nws_forecast_update');
...
async function fetchAndSaveForecast(zone, zoneType) {
  try {
    ...
    logger.error(`Unable to fetch and save forecast for zoneid ${zone['ID']} and zonetype ${zoneType}: ${error.message}`);
...
async function fetchAndSaveAllForecasts() {
  ...
  for (const zoneType in zones) {
    for (const zoneId in zones[zoneType]) {
      ...
      const skipZoneIds = [
        'PZZ576','PZZ530','PZZ531','LMZ779','LMZ080','LMZ777','LMZ878','LMZ675','LMZ876','LMZ673','LMZ671','LMZ669',
        'LMZ870','LMZ845','LMZ846','LMZ847','LMZ745','LMZ043','LMZ744','LHZ442','LCZ460','LHZ443','LCZ422','LOZ030',
        'LSZ144','LSZ145','LSZ143','LSZ142','LSZ141','LSZ140','LSZ146','LSZ147','LSZ121','LSZ148','LSZ162','LSZ240',
        'LSZ241','PZZ570','PZZ475','PZZ450','PZZ415','PZZ470','PZZ376','PZZ370','PZZ176','PZZ173','PZZ210','PZZ350',
        'PZZ545','PZZ540','PZZ455','PZZ170','PZZ130','PZZ131','PZZ135','PZZ156','PZZ150','LSZ245','LSZ246','LSZ247',
        'LSZ248','LSZ249','LSZ250','LSZ251','LSZ265','LMZ522','LMZ521','LMZ221','LMZ541','LMZ250','LSZ321','LSZ322',
        'LMZ248','LHZ346','LMZ341','LHZ361','LHZ347','LHZ345','LMZ323','LMZ364','LMZ362','LMZ344','LMZ342','LSZ266',
        'LSZ267','LMZ643','LMZ543','LMZ542','LMZ346','LCZ423','LEZ444','LEZ142','LEZ163','LEZ143','LEZ144','LEZ145',
        'LEZ146','LMZ567','LMZ868','LMZ565','LMZ366','LMZ563','LMZ046','LMZ844','LMZ743','LMZ742','LMZ741','LMZ740',
        'LMZ646','LMZ645','LMZ644','LHZ348','LHZ349','LHZ421','LHZ422','LHZ363','LHZ441','LHZ462','LMZ261','LHZ362',
        'LHZ463','LEZ147','LEZ148','LEZ149','LEZ040','LOZ043','LOZ044','LHZ464','LEZ162','LEZ164','LEZ165','LEZ166',
        'LEZ167','LEZ041','LEZ020','SLZ024','LOZ045','LEZ168','LEZ169','LEZ061','LOZ042','LOZ062','LOZ063','LOZ064',
        'LOZ065','LMZ849','LMZ848','LMZ345','LSZ242','LSZ243','LSZ244','LMZ874','LMZ872','PZZ565','PZZ560','PZZ535',
        'PZZ650','PZZ673','PZZ645','PZZ110','PZZ153','PZZ655','PZZ132','PZZ134','PZZ133','PZZ676','PZZ750','PZZ775',
        'PZZ575','PZZ571','PZZ670','LSZ263','LSZ264','PZZ356','PZZ410','SLZ022','LSZ150','AMZ178','AMZ170','AMZ172',
        'AMZ174','AMZ176','ANZ676','ANZ670','ANZ672','ANZ674','ANZ678','ANZ370','ANZ475','ANZ373','ANZ375','ANZ470',
        'ANZ471','ANZ472','ANZ473','ANZ172','ANZ271','ANZ070','ANZ273','ANZ272','ANZ270','ANZ071','ANZ170','ANZ174',
        'PMZ191','AMZ270','AMZ272','AMZ370','AMZ274','AMZ276','AMZ372','PZZ271','PZZ251','PZZ253','PZZ252','PZZ273',
        'PZZ272','PZZ900','PZZ915','PZZ920','PZZ930','PZZ940','PZZ840','PZZ835','PZZ935','PZZ800','PZZ905','PZZ805',
        'PZZ910','PZZ810','PZZ815','PZZ820','PZZ925','PZZ825','PZZ830','PZZ945',
